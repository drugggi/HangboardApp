...
public final class FingerAnimationBuilder {
    ...
    private static int[] leftHand_2b_to_x = {R.drawable.animation_left_2b_to_4,0,0,0,0,0};
    ...
    private static int[] rightHand_2b_to_x = {R.drawable.animation_right_2b_to_4,0,0,0,0,0};
