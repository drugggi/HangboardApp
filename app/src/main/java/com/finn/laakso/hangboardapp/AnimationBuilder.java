...
public final class AnimationBuilder {
    ...
    private static int[] leftHand_2f_to_x = {R.drawable.animation_left_2f_to_4,0,0,0,0,0};
    ...
    private static int[] rightHand_2f_to_x = {R.drawable.animation_right_2f_to_4,0,0,0,0,0};
