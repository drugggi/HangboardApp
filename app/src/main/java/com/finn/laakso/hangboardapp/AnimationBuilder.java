...
public final class AnimationBuilder {
    ...
    private static int[] leftHand_4_to_x = {
            0,R.drawable.animation_left_4_to_3f,R.drawable.animation_left_4_to_3b,0,R.drawable.animation_left_4_to_2m,0};

    private static int[] leftHand_3f_to_x = {
            R.drawable.animation_left_3f_to_4,0,R.drawable.animation_left_3f_to_3b,0,0,0};
    ...
    private static int[] leftHand_2m_to_x = {R.drawable.animation_left_2m_to_4,0,0,0,0,0};
    ...
    private static int[] rightHand_4_to_x = {
            0,R.drawable.animation_right_4_to_3f,R.drawable.animation_right_4_to_3b,0,R.drawable.animation_right_4_to_2m,0};

    private static int[] rightHand_3f_to_x = {
            R.drawable.animation_right_3f_to_4,0,R.drawable.animation_right_3f_to_3b,0,0,0};
    ...
    private static int[] rightHand_2m_to_x = {R.drawable.animation_right_2m_to_4,0,0,0,0,0};
