...
private static final int[] gripValuesBM1000 = {
    ...
    private static final int[] gripValuesBM2000 = {
         ...
         8, 14, 40, 8, 9, 50, 8, 40, 60,
         9, 25, 40, 9, 18, 50, 9, 69, 60,
            10, 2, 11, 10, 4, 21, 10, 5, 31,
         11, 14, 10, 11, 22, 20, 11, 25, 30,
         12, 170, 70, 12, 125, 80, 12, 350, 90, 12, 450, 100,
            13, 400, 40, 13, 350, 50, 13, 700, 60,
            14, 500, 40, 14, 450, 50, 14, 800, 60,
         15, 8, 11, 15,13,21, 15,16,31,

    };

    private static final int[] gripValuesTrans = {
            1, 1, 10, 1, 2, 20, 1, 2, 30, 1, 13, 40, 1, 11, 50, 1, 31, 60, 1, 50, 70, 1, 35, 80, 1, 150, 90,
            2, 6, 10, 2, 13, 20, 2, 14, 30, 2, 40, 40, 2, 25, 50, 2, 50, 60, 2, 150, 70, 2, 100, 80,
            3, 10, 10, 3, 17, 20, 3, 20, 30, 3, 80, 40, 3, 50, 50, 3, 90, 60,
            4, 13, 10, 4, 28, 20, 4, 30, 30, 4, 90, 40, 4, 70, 50, 4, 150, 60,
            5, 19, 10, 5, 43, 20, 5, 46, 30, 5, 160, 40, 5, 100, 50, 5, 300, 60,
            6, 35, 10, 6, 55, 20, 6, 65, 30, 6, 250, 40, 6, 150, 50, 6, 500, 60,
            7, 50, 10, 7, 189, 20, 7, 250, 30, 7, 400, 50,
            8, 59, 10, 8, 250, 20, 8, 300, 30,
            9, 100, 10, 9, 350, 20, 9, 450, 30,
