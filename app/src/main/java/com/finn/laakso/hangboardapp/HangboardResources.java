...
private static final int[] gripValuesBM1000 = {
    ...
    private static final int[] gripValuesMoonhard = {
            1, 5, FF, 1, 15, F3, 1, 17, B3, 1, 80, 40, 1, 68, 50, 1, 134, 60,
            2, 45, FF,
            3, 9, FF, 3, 20, F3, 3, 23, B3,
            4, 12, FF, 4, 25, F3, 4, 29, B3, 4, 123, 40, 4, 113, 50,
            5, 70, FF,5, 200, F3, 5, 250, B3,
            6, 19, FF, 6, 75, F3, 6, 80, B3,
            7, 15, FF, 7, 40, F3, 7, 45, B3, 7, 113, 40, 7, 98, 50,
            8, 70, 41, 8, 55, 51, 8, 150, 61,

    };

    private static final int[] gripValuesMooneasy = {
            1, 1, FF, 1, 2, F3, 1, 3, B3, 1, 30, 40, 1, 25, 50, 1, 46, 60,
            2, 8, FF, 2, 15, F3, 2, 17, B3,
            3, 3, FF, 3, 12, F3, 3, 14, B3,
            4, 2, FF, 4, 3, F3, 4, 4, B3, 4, 19, 40, 4, 14, 50, 4, 42, 60,
            5, 10, FF, 5, 19, F3, 5, 21, B3,
            6, 3, FF, 6, 4, F3, 6, 5, B3, 6, 21, 40, 6, 15, 50, 6, 48, 60,
